    ...
    <div className="bg-dark-light rounded-lg shadow-lg p-6 md:p-8 mb-8 border border-dark-lighter">
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-primary text-neutral font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition text-lg flex items-center gap-2 justify-center"
        >
